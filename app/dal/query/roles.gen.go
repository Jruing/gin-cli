...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.Rolename = field.NewString(tableName, "rolename")
	_role.Status = field.NewInt32(tableName, "status")
	_role.Created = field.NewTime(tableName, "created")
...
func (r *role) updateTableName(table string) *role {
	...
	r.Rolename = field.NewString(table, "rolename")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["id"] = r.ID
	r.fieldMap["rolename"] = r.Rolename
